...
| H10 | После deploy проверить gateway, 68 MCP tools, два контейнера, timer и свежий Hermes archive | Всё active/healthy, restart count не растёт, Telegram 409 отсутствует |
