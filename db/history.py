...
# ATTESTATION_KEYS — freshness и immutable target snapshot ТОГО хода; повтор обязан получить СВОИ,
# свежие, иначе унаследовал бы чужое «прочитано»/identity. Берём общей константой, а не литералом:
# новый ключ аттестации добавляется в одном месте.
