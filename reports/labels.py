...
_EN: dict[str, str] = {
    ...
    "Что не так": "Issue",
    "Проверка": "Check",
    # колонки фактов листа «Находки» (замечание 5, 2026-07-17). «Расход»/«Клики» в METRIC_HEADERS
    # переводятся позиционно и в _EN не попадали — листу находок нужны отдельные пары.
    "Расход": "Cost",
    "Клики": "Clicks",
    "Тип соответствия": "Match type",
    "Ключ/запрос": "Keyword/term",
