...
правило #1): здесь только левая половина — черновик. Исполнение намеренно НЕ зарегистрировано как
MCP-инструмент до появления доверенного reply-anchor канала (§15.2).
