...
def _remote_credentials(client_config: dict, scopes: list[str]):
    ...
    print(
        ...
        "3. Разреши ОБА доступа: файлы, созданные приложением (drive.file), и просмотр таблиц\n"
        "   (spreadsheets.readonly). К почте и остальному Диску доступа приложение не получает.\n"
