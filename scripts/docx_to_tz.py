...
> этого Markdown, unified-артефакта или кода с оригиналом исправляется производный слой.
...
Производные implementation notes и код не переопределяют исходные требования.
