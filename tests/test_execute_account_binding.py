...
черновик не сжигается). Штамп — любой ВИДИМЫЙ аккаунт (prod-дефолт allow_all_visible, решение
владельца 2026-07); перепроверка ensure_allowed гарантирует, что он всё ещё в потолке. Сквозной
гейт на не-Draft аккаунте — tests/test_mutations_all_accounts.py.
"""
