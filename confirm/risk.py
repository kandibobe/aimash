...
`confirm.risk`**. Тир не участвует в исполнении — ни в `ensure_allowed`, ни в `claim`, ни в
провенансе, ни в одной из девяти проверок §2.2. Он влияет ровно на четыре презентационные вещи:
...
4. число независимых человеческих актов (L3 — два шага, как у необратимых удалений).
