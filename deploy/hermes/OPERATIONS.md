...
с `mcp_server.server.expected_tool_names()` (базово 87: 27 READ-инструментов + 1 META + 15 PLAN/state +
42 ACTION + 1 composite + 1 WRITE; 89 при `RESEARCH_ARCHIVE_ENABLED=true`), затем в чате спросить агента
