...
с `mcp_server.server.expected_tool_names()` (базово 86: 26 READ-инструментов + 1 META + 15 PLAN/state +
42 ACTION + 1 composite + 1 WRITE; 88 при `RESEARCH_ARCHIVE_ENABLED=true`), затем в чате спросить агента
