...
DEFAULT_AUDIT_THRESHOLDS: dict[str, float] = {
    ...
    # Ф9 (индустриальные чек-листы, волна 2026-07-17).
    "device_min_spend": 20.0,  # устройство с расходом ≥ N — ниже разрыв CPA/нулевые конверсии шум
    "device_cpa_factor": 2.0,  # CPA устройства ≥ N × CPA остальных устройств кампании → разрыв
    "no_value_min_conv": 10.0,  # конверсий ≥ N, а value = 0 → ценность не передаётся (tROAS невозможен)
}
