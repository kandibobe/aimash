...
| 3 · READ-инструменты | ✅ 15 READ-инструментов из 37 по реестру §6.1, round-trip через Hermes доказан живьём |
...
mcp_server/   тул-слой для Hermes: 15 READ ✅, MEMORY/PLAN/WRITE — Волна 1        ← пишется заново
