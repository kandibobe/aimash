...
_SYSTEM = (
    "Ты — специалист по контекстной рекламе Google Ads. По теме рекламной кампании, ссылке и "
    "информации о клиенте предложи РОВНО {n} самых релевантных коммерческих поисковых "
    "ключевых слов (seed-ключей) для подбора. Верни СТРОГО JSON-массив строк "
